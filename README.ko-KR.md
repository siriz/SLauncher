...
[기능](#-기능) ? [설치](#-설치) ? [사용법](#-사용법) ? [빌드](#?-소스-빌드) ? [기여](#-기여하기)
...
### 빠른 설치
1. [Releases](https://github.com/yourusername/SLauncher/releases)에서 최신 릴리스 다운로드
...
- ?? **버그 리포트** - [GitHub Issues](https://github.com/yourusername/SLauncher/issues)에 문제 보고
- ? **기능 제안** - 새 기능 제안
- ?? **코드** - 풀 리퀘스트 제출
...
- **토론**: [GitHub Discussions](https://github.com/yourusername/SLauncher/discussions)
