...
namespace SLauncher.Controls.GridViewItems
{
    public sealed partial class GridViewTile : UserControl
    {
        ...
        private static void OnSizeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (newScale != null)
            {
                // Calculate new dimensions for the container
                ...
                // Update ONLY image size, not text size
                // Icon size scales with the scale value
                ...
                // KEEP font size FIXED at 12 (do not scale with icon size)
                gridViewTile.TileText.FontSize = 12;
      ...
      App.MainWindow.DispatcherQueue.TryEnqueue(() =>
{
       App.MainWindow.AppWindow.Hide();
        ...
        {
            // Linked folder feature has been removed from UI
    // This method is kept for backward compatibility but does nothing
         // Existing linked folder items will still display but cannot be unlinked
            return;
     }
