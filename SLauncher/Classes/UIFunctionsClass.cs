...
namespace SLauncher.Classes
{
    ...
    public static class UIFunctionsClass
    {
        ...
        public static void CreateModalWindow(Window modalWindow, Window parentWindow)
        {
            ...
            // Set modal window to always on top (above parent, even if parent has always on top)
        ...
        /// <summary>
        /// Method to bring a window to front and activate it
        /// </summary>
        /// <param name="window">Window to bring to front</param>
